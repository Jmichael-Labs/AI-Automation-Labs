#!/usr/bin/env python3
"""
Clean Veo 3 video generator v2 - WORKING VERSION WITH RETRY
Fixes all issues and adds retry logic
"""
...
def generate_single_video_segment(segment_prompt, segment_number, industry, max_retries=2):
    ...
    for retry_attempt in range(max_retries + 1):
        ...
        try:
            ...
            print(f"🚀 GENERATING with Veo 3 - Segment {segment_number} (attempt {retry_attempt + 1})")
            ...
            if operation.response and operation.response.generated_videos:
                ...
                if os.path.exists(video_filename):
                    ...
                    print(f"🎥 VEO 3 REAL VIDEO successfully generated! (attempt {retry_attempt + 1})")
            ...
            print(f"⚠️ Veo 3 generation failed for segment {segment_number} (attempt {retry_attempt + 1}): {e}")
            if retry_attempt < max_retries:
                print(f"🔄 Will retry in 30 seconds...")
            else:
                print(f"❌ All retry attempts exhausted for segment {segment_number}")
...
if __name__ == "__main__":
    ...
    if result:
        ...
        print("❌ FAILED to generate video after all retries")